...
mod test {
    ...
    fn test_legacy_ms_oapxbc_load() {
        ...
        let loadable_root = LoadableMachineKey::SoftAes256GcmV1 {
            key: [
                55, 158, 111, 36, 38, 198, 93, 157, 81, 235, 4, 61, 240, 164, 119, 203, 38, 163,
                10, 176, 48, 170, 108, 223, 5, 113, 175, 31, 4, 122, 7, 58,
            ]
            .into(),
            tag: [
        ...
        let loadable_ms_oapxbc = LoadableMsOapxbcRsaKey::Soft2048V1 {
            key: [
        ...
        let ms_oapxbc_key = soft_tpm
            .msoapxbc_rsa_key_load(&root_storage, &loadable_ms_oapxbc)
            .unwrap();
